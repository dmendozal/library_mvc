        ...
        <div class="row">
            ...
            <main class="col-xs-12 col-sm-8 offset-sm-4 col-lg-9 offset-lg-3 col-xl-10 offset-xl-2 pt-3 pl-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="login100-form validate-form p-b-33 p-t-5" method="POST" action="?controller=Book&action=store">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="stock" name="stock" class="form-control" value="" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="year" name="year" class="form-control" value="" required>
                            </div>
                            <div class="form-group">
